...
export default function AdminBlog() {
  ...
  const { data: posts = [], isLoading } = useQuery({
    ...
    queryFn: () => statusFilter === 'all'
      ? base44.asServiceRole?.entities?.BlogPost?.list('-created_date', 50) ?? base44.entities.BlogPost.list('-created_date', 50)
      : base44.entities.BlogPost.filter({ status: statusFilter }, '-created_date', 50),
  });
