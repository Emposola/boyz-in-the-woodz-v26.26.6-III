...
VALUES (
  ...
  'Marcus Trail', 'campfire_talk', 'recorded', NOW() - INTERVAL '3 days', 90,
  '', 'https://www.youtube.com/embed/dQw4w9WgXcQ',
  'https://images.unsplash.com/photo-1542273917363-3b1817f69a2d?w=1200&q=85',
  4200, true, true, ARRAY['the-code', 'brotherhood', 'recorded']
...
VALUES (
  ...
  'Coach Mike', 'q_and_a', 'recorded', NOW() - INTERVAL '7 days', 60,
  '', 'https://www.youtube.com/embed/dQw4w9WgXcQ',
  'https://images.unsplash.com/photo-1448375240586-882707db888b?w=1200&q=85',
  2800, false, true, ARRAY['q-and-a', 'new-members', 'retreat']
) ON CONFLICT (slug) DO NOTHING;
...
VALUES (
  ...
  'Dr. Antoine G. & Marcus Trail', 'retreat_prep', 'recorded', NOW() - INTERVAL '14 days', 80,
  '', 'https://www.youtube.com/embed/dQw4w9WgXcQ',
  'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=1200&q=85',
  1900, false, true, ARRAY['archetypes', 'workshop', 'identity']
) ON CONFLICT (slug) DO NOTHING;
...
VALUES (
  ...
  'Brotherhood Team', 'announcement', 'recorded', NOW() - INTERVAL '21 days', 45,
  '', 'https://www.youtube.com/embed/dQw4w9WgXcQ',
  'https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?w=1200&q=85',
  5100, false, true, ARRAY['big-bend', 'announcement', 'retreat']
) ON CONFLICT (slug) DO NOTHING;
...
VALUES (
  ...
  'Dre Williams', 'barber_live', 'recorded', NOW() - INTERVAL '5 days', 60,
  '', 'https://www.youtube.com/embed/dQw4w9WgXcQ',
  'https://images.unsplash.com/photo-1503951914875-452162b0f3f1?w=1200&q=85',
  2300, false, true, ARRAY['barber', 'technique', 'recorded']
) ON CONFLICT (slug) DO NOTHING;
...
VALUES (
  ...
  'Coach Mike & Marcus Trail', 'mens_circle', 'recorded', NOW() - INTERVAL '10 days', 120,
  '', 'https://www.youtube.com/embed/dQw4w9WgXcQ',
  'https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?w=1200&q=85',
  4800, false, true, ARRAY['mens-circle', 'retreat', 'campfire']
) ON CONFLICT (slug) DO NOTHING;
...
VALUES (
  ...
  'Dr. Antoine G.', 'retreat_prep', 'recorded', NOW() - INTERVAL '4 days', 55,
  '', 'https://www.youtube.com/embed/dQw4w9WgXcQ',
  'https://images.unsplash.com/photo-1447752875215-b2761acb3c5d?w=1200&q=85',
  3400, false, true, ARRAY['science', 'cortisol', 'mental-health']
) ON CONFLICT (slug) DO NOTHING;
...
VALUES (
  ...
  'Marcus Trail', 'announcement', 'recorded', NOW() - INTERVAL '2 days', 35,
  '', 'https://www.youtube.com/embed/dQw4w9WgXcQ',
  'https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=1200&q=85',
  6700, true, true, ARRAY['survival-pack', 'gear', 'the-code']
) ON CONFLICT (slug) DO NOTHING;
...
VALUES (
  ...
  'Coach Mike', 'campfire_talk', 'upcoming', NOW() + INTERVAL '3 days', 90,
  ...
  0, true, true, ARRAY['grief', 'campfire', 'upcoming']
) ON CONFLICT (slug) DO NOTHING;
...
VALUES (
  ...
  'Dre Williams', 'barber_live', 'upcoming', NOW() + INTERVAL '6 days', 75,
  'https://www.youtube.com/embed/live_stream?channel=UCxxxxxx', '',
  'https://images.unsplash.com/photo-1621605815971-fbc98d665033?w=1200&q=85',
  0, false, true, ARRAY['barber', 'technique', 'upcoming']
) ON CONFLICT (slug) DO NOTHING;
...
VALUES (
  ...
  'Coach Mike', 'retreat_prep', 'upcoming', NOW() + INTERVAL '1 day', 45,
  'https://www.youtube.com/embed/live_stream?channel=UCxxxxxx', '',
  'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=1200&q=85',
  0, false, true, ARRAY['retreat-prep', 'weekend-reset', 'packing']
) ON CONFLICT (slug) DO NOTHING;
...
VALUES (
  ...
  'Ryan Cooper', 'q_and_a', 'upcoming', NOW() + INTERVAL '10 days', 50,
  'https://www.youtube.com/embed/live_stream?channel=UCxxxxxx', '',
  'https://images.unsplash.com/photo-1553729459-afe8f2e2a56a?w=1200&q=85',
  0, false, true, ARRAY['points', 'loyalty', 'brotherhood', 'upcoming']
) ON CONFLICT (slug) DO NOTHING;
