...
export default function AdminStudio() {
  ...
  const { data: sessions = [], isLoading } = useQuery({
    ...
    queryFn: () => api.entities.StudioSession.list('-scheduled_at', 100),
  });

  const createMutation = useMutation({
    mutationFn: data => api.entities.StudioSession.create(data),
  ...
  const updateMutation = useMutation({
    mutationFn: ({ id, data }) => api.entities.StudioSession.update(id, data),
  ...
  const deleteMutation = useMutation({
    mutationFn: id => api.entities.StudioSession.delete(id),
