...
export default function Shop() {
  ...
  return (
    <div className="min-h-screen">
      <SEO
        title={isBoyz ? 'Survival Pack 01 — Shop Gear' : 'The Chair — Barber Merch'}
        description={isBoyz
          ? 'Hoodies, tees, caps, crewnecks — gear forged in the woods. Worn as proof. Shop the Survival Pack 01 collection.'
          : 'Aprons, pomade, combs, tees — essentials from The Chair barbershop.'}
        canonical={`/shop/${business}`}
      />
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 pb-8 w-full">
          ...
          <p className="text-sm text-muted-foreground mt-2 max-w-lg">
            {isBoyz
              ? 'Proof you were there. Proof you understand. Proof you chose to reset. Gear forged in the woods — worn as proof.'
