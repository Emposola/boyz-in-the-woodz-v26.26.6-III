...
export default function TheCode() {
  ...
  return (
    <div className="min-h-screen">
      <SEO
        title="The Code — 5 Non-Negotiable Rules"
        description="No Phones. Show Up Physically. Respect Everyone. No Ego. Leave Better. The five non-negotiable rules that make the brotherhood real."
        canonical="/the-code"
        jsonLd={{
          '@context': 'https://schema.org',
          '@type': 'WebPage',
          name: 'The Code',
          description: 'The 5 non-negotiable rules of Boyz In The Woodz: No Phones, Show Up, Respect, No Ego, Leave Better.',
